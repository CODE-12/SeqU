...
function PH(){
    ...
    var H = parseFloat(document.getElementById("trkez").value);
    var result ;
    var tips;
...
function POH(){
    ...
    var pOH = parseFloat(document.getElementById("pH").value);
    var OH = parseFloat(document.getElementById("trkez").value);
    var result ;
    var tips;
    ...
    if(pOH == "0.0"){
        ...
        tips="pOH = - log[H] "+"<br />"+"pOH = - log("+OH+")";
            document.getElementById("result").innerHTML=result;
        document.getElementById("sh2").innerHTML=tips; 
    }
